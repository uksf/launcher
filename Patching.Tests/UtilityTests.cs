...
namespace Patching.Tests {
    public class UtilityTests {
        [Test]
        public void UtilityTestsShaFromConcurrent() {
            ConcurrentDictionary<string, string> filesDictionary = new ConcurrentDictionary<string, string>();
            filesDictionary.TryAdd("1", "78e10ca71a8e8060f5fba1b261fdff222806bc79");
            filesDictionary.TryAdd("2", "d09adbeb611cde10bfe1c52353cbfabc320bb5df");
            string sha = Utility.ShaFromConcurrent(filesDictionary);
        ...
        public void UtilityTestsSha() {
            ...
            Dictionary<string, string> signaturesDictionary =
                new Dictionary<string, string> { { "1", sha1 }, { "2", sha2 } };
            string sha = Utility.ShaFromDictionary(signaturesDictionary);
        ...
        public void UtilityTestsShaOtherLocation() {
            ...
            Dictionary<string, string> signaturesDictionary1 =
                new Dictionary<string, string> { { "1", sha11 }, { "2", sha12 } };
            ...
            Dictionary<string, string> signaturesDictionary2 =
                new Dictionary<string, string> { { "1", sha21 }, { "2", sha22 } };
