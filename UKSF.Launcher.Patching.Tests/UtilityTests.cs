...
namespace UKSF.Launcher.Patching.Tests {
    public class UtilityTests {
        ...
        public void UtilityTestsSha() {
            string sha1 = Utility.ShaFromFile(@"E:\Workspace\UKSF.Old.Launcher\UKSF.Old.Launcher\UKSF.Old.Launcher.Patching.Tests\test\1.txt");
            string sha2 = Utility.ShaFromFile(@"E:\Workspace\UKSF.Old.Launcher\UKSF.Old.Launcher\UKSF.Old.Launcher.Patching.Tests\test\2.txt");
        ...
        public void UtilityTestsShaOtherLocation() {
            string sha11 = Utility.ShaFromFile(@"E:\Workspace\UKSF.Old.Launcher\UKSF.Old.Launcher\UKSF.Old.Launcher.Patching.Tests\test\1.txt");
            string sha12 = Utility.ShaFromFile(@"E:\Workspace\UKSF.Old.Launcher\UKSF.Old.Launcher\UKSF.Old.Launcher.Patching.Tests\test\2.txt");
            ...
            string sha21 = Utility.ShaFromFile(@"E:\Workspace\UKSF.Old.Launcher\UKSF.Old.Launcher\UKSF.Old.Launcher.Patching.Tests\test\other\1.txt");
            string sha22 = Utility.ShaFromFile(@"E:\Workspace\UKSF.Old.Launcher\UKSF.Old.Launcher\UKSF.Old.Launcher.Patching.Tests\test\other\2.txt");
